...
describe('A função filterByValue', () => {
  ...
  test('Moedas acima de 50', () => {
    ...
    return filterByValue(50).then((data) => {
  ...
  test('Moedas acima de 1000', () => {
    ...
    return filterByValue(1000).catch((data) => {
      expect(data).toEqual('Nenhuma moeda encontrada.');
    });
  });
  ...
  test('Moedas acima de 1000 - Async/Await', async () => {
    ...
    try {
      ...
      expect(error).toEqual('Nenhuma moeda encontrada.');
    }
  });
});
