...
//   console.log(citiesAndStates);
  ...
  const citiesAndStatesName = cities.map(city => {
    const findState = states.find(state => state.short === city.state); // Para utilizar dois elementos de dois objetos diferentes, os dois objetos tem que ter algo em comum. No caso dos objetos utilizados (cities e states) possuem as siglas dos estados iguais. Mesmo que suas respectivas chaves não possuem o mesmo nome, o importante é o valor.
